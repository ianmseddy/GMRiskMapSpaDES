# gmapAPI()
#' the gmap function with an argument for API key
#' @param x a raster or extent object
#' @param apikey Character; an API key
#' @param filename Character; see dismo::gmap
#' @param type Character; see dismo::gmap 
#' @param style Character; see dismo::gmap
#' @param minDist Numeric; see dismo::gmap
#' @param maxDist Numeric; see dismo::gmap
#' @param size Numeric; see dismo::gmap
#' @param rgb Logical: see dismo::gmap
#' @param lonlat Logical: see dismo::gmap
#' @return a raster map 
#' @export
gmapAPI <-function (x, exp = 1, type = "terrain", filename = "", style = NULL,

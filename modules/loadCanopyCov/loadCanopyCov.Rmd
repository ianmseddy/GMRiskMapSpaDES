...
moduleDir <- file.path("C:/Brian/Projects/Spades/GMRiskMapSpaDES/modules")
...
If `sourceURL` is specified, `downloadData("loadCanopyCov", "path/to/modules/dir")` may be sufficient.

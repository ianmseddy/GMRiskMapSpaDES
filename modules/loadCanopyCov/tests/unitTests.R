...
test_dir("C:/Brian/Projects/Spades/GMRiskMapSpaDES/modules/loadCanopyCov/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Brian/Projects/Spades/GMRiskMapSpaDES/modules/loadCanopyCov/tests/testthat/test-template.R")

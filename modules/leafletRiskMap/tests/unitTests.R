...
test_dir("/Users/kaitlynschyrmann/Desktop/SpaDES GM Module 2018/GMRiskMapSpaDES/modules/leafletRiskMap/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("/Users/kaitlynschyrmann/Desktop/SpaDES GM Module 2018/GMRiskMapSpaDES/modules/leafletRiskMap/tests/testthat/test-template.R")

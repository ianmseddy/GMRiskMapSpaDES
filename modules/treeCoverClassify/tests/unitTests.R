...
test_dir("C:/Ian/Van Hezewijk/GMRiskMapSpaDES/modules/treeCoverClassify/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Ian/Van Hezewijk/GMRiskMapSpaDES/modules/treeCoverClassify/tests/testthat/test-template.R")
